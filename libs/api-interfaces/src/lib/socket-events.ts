...
export type SocketEvents = CARD_CREATED_EVENT | CARD_UPDATED_EVENT | CARD_DELETED_EVENT | COLUMN_CREATED_EVENT | COLUMN_UPDATED_EVENT | COLUMN_DELETED_EVENT | BOARD_UPDATED_EVENT
