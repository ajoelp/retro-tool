...
export async function hasAccessToBoard(req: ApiRequest, res: Response, next: NextFunction) {
  next()
}

export const CardAccessError = 'User does not have access to edit this card.'

export async function canEditCard(req: ApiRequest, res: Response, next: NextFunction) {
